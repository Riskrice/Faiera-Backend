...
export class TeachersController {
  ...
  async createTeacher(@Body() dto: CreateTeacherFullDto): Promise<ApiResponse<any>> {
  ...
  async requestWithdrawal(
    ...
    const request = await this.teachersService.requestWithdrawal(
      user.sub,
      dto.amount,
      dto.paymentDetails,
    );
  ...
  async processWithdrawal(
    ...
    const request = await this.teachersService.processWithdrawalRequest(
      id,
      dto.action,
      dto.adminNotes,
    );
