...
export class AttemptService {
    ...
    async getAttemptWithQuestions(attemptId: string, userId: string): Promise<{
    ...
    async saveAnswer(
        ...
        answer.answerData = dto.booleanAnswer !== undefined ? { booleanAnswer: dto.booleanAnswer } : undefined;
