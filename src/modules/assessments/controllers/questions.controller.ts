...
export class QuestionsController {
    ...
    async findMyQuestions(
        ...
        return createPaginatedResponse(questions, pagination.page || 1, pagination.pageSize || 20, total);
    }
    ...
    async getPendingReview(
        ...
        const { questions, total } = await this.questionBankService.getPendingReviewQuestions(pagination);
        return createPaginatedResponse(questions, pagination.page || 1, pagination.pageSize || 20, total);
    }
