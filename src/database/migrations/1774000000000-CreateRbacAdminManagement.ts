...
export class CreateRbacAdminManagement1774000000000 implements MigrationInterface {
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        `);
        await queryRunner.query(`ALTER TABLE "permissions" ADD COLUMN IF NOT EXISTS "name" character varying(120)`);
        await queryRunner.query(`ALTER TABLE "permissions" ADD COLUMN IF NOT EXISTS "description" text`);
        await queryRunner.query(`ALTER TABLE "permissions" ADD COLUMN IF NOT EXISTS "created_at" TIMESTAMP WITH TIME ZONE NOT NULL DEFAULT now()`);
        await queryRunner.query(`ALTER TABLE "permissions" ADD COLUMN IF NOT EXISTS "updated_at" TIMESTAMP WITH TIME ZONE NOT NULL DEFAULT now()`);
        await queryRunner.query(`CREATE UNIQUE INDEX IF NOT EXISTS "IDX_permissions_action_resource" ON "permissions" ("action", "resource")`);
        ...
        await queryRunner.query(`
            ...
            END $$;
        `);
        await queryRunner.query(`ALTER TABLE "admin_roles" ADD COLUMN IF NOT EXISTS "created_at" TIMESTAMP WITH TIME ZONE NOT NULL DEFAULT now()`);
        await queryRunner.query(`ALTER TABLE "admin_roles" ADD COLUMN IF NOT EXISTS "updated_at" TIMESTAMP WITH TIME ZONE NOT NULL DEFAULT now()`);
        await queryRunner.query(`ALTER TABLE "admin_roles" ADD COLUMN IF NOT EXISTS "isSystem" boolean NOT NULL DEFAULT false`);
        await queryRunner.query(`CREATE UNIQUE INDEX IF NOT EXISTS "UQ_admin_roles_name" ON "admin_roles" ("name")`);
        ...
        await queryRunner.query(`
            ...
            END $$;
        `);
        await queryRunner.query(`ALTER TABLE "admin_role_permissions" ADD COLUMN IF NOT EXISTS "roleId" uuid`);
        await queryRunner.query(`ALTER TABLE "admin_role_permissions" ADD COLUMN IF NOT EXISTS "permissionId" uuid`);
        await queryRunner.query(`ALTER TABLE "admin_role_permissions" ALTER COLUMN "roleId" SET NOT NULL`);
        await queryRunner.query(`ALTER TABLE "admin_role_permissions" ALTER COLUMN "permissionId" SET NOT NULL`);
        ...
        await queryRunner.query(`
            ...
            END $$;
        `);
        await queryRunner.query(`ALTER TABLE "admin_users" ADD COLUMN IF NOT EXISTS "created_at" TIMESTAMP WITH TIME ZONE NOT NULL DEFAULT now()`);
        await queryRunner.query(`ALTER TABLE "admin_users" ADD COLUMN IF NOT EXISTS "updated_at" TIMESTAMP WITH TIME ZONE NOT NULL DEFAULT now()`);
        await queryRunner.query(`ALTER TABLE "admin_users" ADD COLUMN IF NOT EXISTS "assignedById" uuid`);
        await queryRunner.query(`ALTER TABLE "admin_users" ADD COLUMN IF NOT EXISTS "previousRole" "admin_users_previousrole_enum"`);
        await queryRunner.query(`ALTER TABLE "admin_users" ADD COLUMN IF NOT EXISTS "revokedAt" TIMESTAMP WITH TIME ZONE`);
        await queryRunner.query(`ALTER TABLE "admin_users" ADD COLUMN IF NOT EXISTS "revokedById" uuid`);

        await queryRunner.query(`CREATE UNIQUE INDEX IF NOT EXISTS "UQ_admin_users_userId" ON "admin_users" ("userId")`);
        await queryRunner.query(`CREATE INDEX IF NOT EXISTS "IDX_admin_users_roleId" ON "admin_users" ("roleId")`);
        ...
        `);
        await queryRunner.query(`ALTER TABLE "admin_audit_logs" ADD COLUMN IF NOT EXISTS "created_at" TIMESTAMP WITH TIME ZONE NOT NULL DEFAULT now()`);
        await queryRunner.query(`ALTER TABLE "admin_audit_logs" ADD COLUMN IF NOT EXISTS "updated_at" TIMESTAMP WITH TIME ZONE NOT NULL DEFAULT now()`);
        await queryRunner.query(`ALTER TABLE "admin_audit_logs" ADD COLUMN IF NOT EXISTS "details" jsonb`);
        await queryRunner.query(`ALTER TABLE "admin_audit_logs" ADD COLUMN IF NOT EXISTS "ipAddress" character varying(45)`);
        await queryRunner.query(`ALTER TABLE "admin_audit_logs" ADD COLUMN IF NOT EXISTS "userAgent" text`);

        await queryRunner.query(`CREATE INDEX IF NOT EXISTS "IDX_admin_audit_actorId_createdAt" ON "admin_audit_logs" ("actorId", "created_at")`);
        await queryRunner.query(`CREATE INDEX IF NOT EXISTS "IDX_admin_audit_targetUserId" ON "admin_audit_logs" ("targetUserId")`);
        await queryRunner.query(`CREATE INDEX IF NOT EXISTS "IDX_admin_audit_action_resource" ON "admin_audit_logs" ("action", "resource")`);
    ...
    public async down(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(`ALTER TABLE "admin_audit_logs" DROP CONSTRAINT IF EXISTS "FK_admin_audit_targetUserId_users"`);
        await queryRunner.query(`ALTER TABLE "admin_audit_logs" DROP CONSTRAINT IF EXISTS "FK_admin_audit_actorId_users"`);
        ...
        await queryRunner.query(`ALTER TABLE "admin_users" DROP CONSTRAINT IF EXISTS "FK_admin_users_revokedById_users"`);
        await queryRunner.query(`ALTER TABLE "admin_users" DROP CONSTRAINT IF EXISTS "FK_admin_users_assignedById_users"`);
        await queryRunner.query(`ALTER TABLE "admin_users" DROP CONSTRAINT IF EXISTS "FK_admin_users_roleId_admin_roles"`);
        await queryRunner.query(`ALTER TABLE "admin_users" DROP CONSTRAINT IF EXISTS "FK_admin_users_userId_users"`);
        ...
        await queryRunner.query(`ALTER TABLE "admin_role_permissions" DROP CONSTRAINT IF EXISTS "FK_admin_role_permissions_permission"`);
        await queryRunner.query(`ALTER TABLE "admin_role_permissions" DROP CONSTRAINT IF EXISTS "FK_admin_role_permissions_role"`);
